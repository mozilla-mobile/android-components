...
object GlobalPlacesDependencyProvider {
    ...
    /**
     * Initializes places storage for running the maintenance task via [PlacesStorageMaintenanceWorker].
    ...
    /**
     * Provides [PlacesStorage] globally when needed for [PlacesStorageMaintenanceWorker]
