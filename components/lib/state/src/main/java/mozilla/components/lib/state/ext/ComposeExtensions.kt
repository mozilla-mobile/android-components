 ...
 */
@Composable
inline fun <reified S : State, A : Action> scopedSaveableStore(
        ...
        if (state is Parcelable) {
            ...
            throw NotImplementedError(
                "State of store does not implement Parcelable. Either implement Parcelable or pass " +
                    "custom save function to scopedSaveableStore()"
            )
        }
    },
        ...
        if (parcelable is S) {
            ...
            throw NotImplementedError(
                "Restored parcelable is not of same class as state. Either the state needs to " +
                    "implement Parcelable or you need to provide a custom restore function to scopedSaveableStore()"
            )
        }
    },
