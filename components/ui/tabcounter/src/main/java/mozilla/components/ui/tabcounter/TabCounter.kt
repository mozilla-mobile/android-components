...
open class TabCounter @JvmOverloads constructor(
    ...
    private val binding: MozacUiTabcounterLayoutBinding
    ...
    private fun setColor(color: Int) {
        ...
        binding.counterBox.setImageDrawable(tabCounterBox)
        binding.counterText.setTextColor(color)
    }

    private fun updateContentDescription(count: Int) {
        val counterRoot = findViewById<View>(R.id.counter_root)
    ...
    fun setCount(count: Int) {
        ...
        binding.counterText.text = formatCountForDisplay(count)
    ...
    private fun createBoxAnimatorSet(animatorSet: AnimatorSet) {
        ...
        val moveUp1 = ObjectAnimator.ofFloat(
            binding.counterBox, "translationY",
    ...
    private fun createTextAnimatorSet(animatorSet: AnimatorSet) {
        ...
        val moveDown = ObjectAnimator.ofFloat(
            binding.counterText, "translationY",
    ...
    private fun formatCountForDisplay(count: Int): String {
        return if (count > MAX_VISIBLE_TABS) {
            binding.counterText.updatePadding(bottom = INFINITE_CHAR_PADDING_BOTTOM)
            SO_MANY_TABS_OPEN
        } else {
    ...
    private fun adjustTextSize(newCount: Int) {
        ...
        binding.counterText.setTextSize(TypedValue.COMPLEX_UNIT_PX, textSize)
        binding.counterText.setTypeface(null, Typeface.BOLD)
        binding.counterText.setPadding(0, 0, 0, 0)
    }
