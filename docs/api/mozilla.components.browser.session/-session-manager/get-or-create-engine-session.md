[android-components](../../index.md) / [mozilla.components.browser.session](../index.md) / [SessionManager](index.md) / [getOrCreateEngineSession](./get-or-create-engine-session.md)
